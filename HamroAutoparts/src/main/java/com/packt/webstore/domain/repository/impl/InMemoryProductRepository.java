...
/*
 * 	For now there are 3 products hardcoded and will be loaded from the memory. Later, I am planning to make a separate We service app that will provide full catalog.
 */
